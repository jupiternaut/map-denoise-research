...
GitHub 快照：2026-09-13。当前研究入口是 [V18 报告](exploration_v18/REPORT.md) 和
[可调用算子](exploration_v18/v18_operator.py)；[V17 报告](exploration_v17/REPORT.md)记录自适应空间关联构造。
...
以下保留原始 V2 数据接入说明，**其“当前有效版本”是当时的历史状态，不代表 V18**。
